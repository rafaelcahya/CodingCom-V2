...
const Toggle = () => {
    ...
    return (
        <div className="poppins text-[14px] transition duration-200 ease-in-out">
            {theme === 'dark' ? (
                <div className='flex items-center justify-between gap-1 hover:bg-gray-200 dark:hover:bg-neutral-700 p-2 rounded-md cursor-pointer' onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>
                    <p>Light</p>
