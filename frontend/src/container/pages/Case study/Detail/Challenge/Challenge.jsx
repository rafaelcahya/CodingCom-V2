                ...
                <div className='bg-white text-black dark:text-white dark:bg-[#111213] duration-200 inter flex flex-wrap gap-16 px-10 sm:px-20 py-16'>
                    {
                        Array.from({length: 5}).map((_, i) => (
                            <Link to="" className='flex flex-col gap-5 w-[400px] bg-white dark:bg-[#09080c] p-4 rounded-md dark:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] dark:hover:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)] duration-200'>
