    ...
    return (
        <>
            ...
            <div className='flex flex-col gap-20 letter_spacing_1'>
                <div className='header flex flex-col gap-3 poppins-600 py-20 px-5 md:px-16 lg:px-32 w-full'>
                    <p className='text_20'>Hi Guest</p>
                    <p className='text_25'>Explore the new world of web development</p>
                </div>
                <div className='flex flex-col gap-10 px-5 md:px-16 lg:px-32'>
                    <div className='flex flex-col gap-3'>
                        <p className='poppins-600 text_20'>Popular category</p>
                        <p className='poppins secondary_text text_14'>Many categories for you to learn web development. choose what you want</p>
                    </div>
