                ...
                <Navbar/>
                    <div className='flex flex-col gap-20 px-5 md:px-20 lg:px-32 black'>
                        ...
                        <div className='flex justify-between gap-20 w-full'>
                            <div className='flex flex-col gap-20 w-1/4'>
                                ...
                                <div className='flex flex-col gap-5 text-left text-16 border-r-2'>
                            ...
                            <div className='w-3/4'>
                                <img src={learning} alt="" className='w-4/5 rounded-xl'/>
                                <div className='black flex flex-col gap-10 text-left'>
                                    <p className='poppins-600 text-25'>Lorem ipsum dolo sit amet</p>
                                    <p className='poppins text-16 letterspacing-1 leading-7'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                                    <p className='poppins text-16'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                                </div>
                            </div>
                        </div>
                    </div>
