    ...
    return (
        <>
            <div className='block lg:hidden'>
                {
                    !isOpen ? (
                        <div className='fixed top-0 left-0 flex items-center gap-5 bg-white px-10 py-5 shadow-xl w-full'>
                ...
                <div className={`fixed top-0 left-0 h-full flex flex-col gap-10 bg-white pt-20 px-10 shadow-xl ${isOpen ? 'translate-x-0':'-translate-x-full'} ease-in-out duration-200`}>
