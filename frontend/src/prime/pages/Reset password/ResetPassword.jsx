...
export const ResetPassword = () => {
    return (
        <>
            <div className='reset-password black flex flex-col items-center gap-10 pt-10 pb-20'>
                <p className='poppins-600 text-25 capitalize'>reset password</p>
                <form className='poppins text-15 flex flex-col gap-5 sm:gap-10'>
                    <div className='flex flex-col sm:flex-row gap-5 sm:gap-10'>
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            ...
                            <input type="text" placeholder='Input your old password' className='border-gray width-20 gray px-5 py-2 rounded-lg outline-none' />
                        </div>
                    </div>
                    <div className='flex flex-col sm:flex-row gap-5 sm:gap-10'>
                        <div className='flex flex-col items-start gap-3'>
                    ...
                    <div className='flex flex-col items-center gap-5'>
                        <p className='bg-purple text-white rounded-lg py-3 cursor-pointer w-full text-center capitalize'>reset password</p>
                        <Link to='/signin'>
